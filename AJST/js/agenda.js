...
text += "<table border=0 id='agenda' class='agenda'>" 
text += "<tr><td>" 
text += "<table width=100% id='agenda'><tr>" 
text += "<td align=left>" 
...
    eval("sp"+ii).style.backgroundColor="rgba(37,118,197,0.3)" 
   } 
  } 
 dCount += 1 
  if (dCount>6){ 
